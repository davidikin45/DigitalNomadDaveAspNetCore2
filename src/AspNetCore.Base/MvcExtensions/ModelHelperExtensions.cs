...
namespace AspNetCore.Base.MvcExtensions
{
    public static class ModelHelperExtensions
    {
        ...
        //ModelMetadata
        public static Microsoft.AspNetCore.Mvc.ModelBinding.ModelMetadata ModelMetadata(this ViewDataDictionary viewData, IModelMetadataProvider modelMetadataProvider)
        {
            return ModelMetadata(viewData.Model, modelMetadataProvider);
        }

        public static Microsoft.AspNetCore.Mvc.ModelBinding.ModelMetadata ModelMetadata(this ViewDataDictionary viewData, object model, IModelMetadataProvider modelMetadataProvider)
        {
            return ModelMetadata(model, modelMetadataProvider);
        }

        public static Microsoft.AspNetCore.Mvc.ModelBinding.ModelMetadata ModelMetadata(this object model, IModelMetadataProvider modelMetadataProvider)
        {
