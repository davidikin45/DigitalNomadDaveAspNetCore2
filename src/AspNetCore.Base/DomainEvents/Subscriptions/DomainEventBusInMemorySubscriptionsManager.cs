...
namespace AspNetCore.Base.DomainEvents.Subscriptions
{
    public partial class DomainEventBusInMemorySubscriptionsManager : IDomainEventBusSubscriptionsManager
    {
        ...
        public void AddDynamicSubscription<TDomainEvent,TH>(string eventName)
        ...
        public void RemoveDynamicSubscription<TDomainEvent, TH>(string eventName)
            where TH : IDynamicDomainEventHandler<TDomainEvent>
        {
            var handlerToRemove = FindDynamicSubscriptionToRemove<TDomainEvent, TH>(eventName);
